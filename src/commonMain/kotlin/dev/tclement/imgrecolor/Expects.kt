...
expect suspend fun readTextFromFile(path: String): String

expect fun exitProcess(status: Int): Nothing

expect suspend fun readImageFromFile(path: String): DecodedImage

expect suspend fun writeImageToFile(image: DecodedImage, path: String)
